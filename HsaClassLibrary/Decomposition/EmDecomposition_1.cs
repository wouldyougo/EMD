...
namespace HsaClassLibrary.Decomposition
{
    ...
    /// </remarks>
	public class EmDecomposition_1 : EmDecomposition
	{
        /// <summary>
        /// 
        /// </summary>
        ...
        */
        ...
        public override void FindExt(IList<double> source1, out IList<double> xMax, out IList<double> yMax, out IList<double> xMin, out IList<double> yMin)
        {
            ...
            if (y.Count > 0)
            {
                ...
                //Если меньше предпоследненго то минимум
                //максимум выбыраем из полседнего максимума
                ...
                //Если большего предпоследненго то максимум
                //минимум выбыраем из полседнего минимум
                else if (y[y.Count - 1] >= y[y.Count - 2])
                {
                    xMax.Add(y.Count - 1);
                    yMax.Add(y[y.Count - 1]);
